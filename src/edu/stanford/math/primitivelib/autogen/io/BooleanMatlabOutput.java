...
import edu.stanford.math.primitivelib.autogen.matrix.BooleanSparseVector;
import edu.stanford.math.primitivelib.autogen.matrix.BooleanVectorEntry;
...
public class BooleanMatlabOutput {
	...
	public static void writeAsMatlabSparseCol(Writer writer, BooleanSparseMatrix matrix, String name) throws IOException {
