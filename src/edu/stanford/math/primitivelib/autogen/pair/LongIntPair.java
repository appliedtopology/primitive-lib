...
public class LongIntPair {
	...
	/**
	 * Constructor which initializes from another LongIntPair.
	 * 
	 * @param pair the LongIntPair to initialize from
	 */
	public LongIntPair(LongIntPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LongIntPair other = (LongIntPair) obj;
