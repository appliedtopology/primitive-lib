...
public class ObjectLongPair<T> {
	...
	/**
	 * Constructor which initializes from another ObjectLongPair<T>.
	 * 
	 * @param pair the ObjectLongPair<T> to initialize from
	 */
	public ObjectLongPair(ObjectLongPair<T> pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final ObjectLongPair<?> other = (ObjectLongPair<?>) obj;
