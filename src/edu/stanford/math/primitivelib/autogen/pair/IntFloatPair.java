...
public class IntFloatPair {
	...
	/**
	 * Constructor which initializes from another IntFloatPair.
	 * 
	 * @param pair the IntFloatPair to initialize from
	 */
	public IntFloatPair(IntFloatPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final IntFloatPair other = (IntFloatPair) obj;
