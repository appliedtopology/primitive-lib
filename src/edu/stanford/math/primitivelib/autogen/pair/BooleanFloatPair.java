...
public class BooleanFloatPair {
	...
	/**
	 * Constructor which initializes from another BooleanFloatPair.
	 * 
	 * @param pair the BooleanFloatPair to initialize from
	 */
	public BooleanFloatPair(BooleanFloatPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final BooleanFloatPair other = (BooleanFloatPair) obj;
