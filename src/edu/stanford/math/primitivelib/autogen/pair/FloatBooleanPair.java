...
public class FloatBooleanPair {
	...
	/**
	 * Constructor which initializes from another FloatBooleanPair.
	 * 
	 * @param pair the FloatBooleanPair to initialize from
	 */
	public FloatBooleanPair(FloatBooleanPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final FloatBooleanPair other = (FloatBooleanPair) obj;
