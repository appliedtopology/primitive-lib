...
public class FloatLongPair {
	...
	/**
	 * Constructor which initializes from another FloatLongPair.
	 * 
	 * @param pair the FloatLongPair to initialize from
	 */
	public FloatLongPair(FloatLongPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final FloatLongPair other = (FloatLongPair) obj;
