...
public class FloatFloatPair {
	...
	/**
	 * Constructor which initializes from another FloatFloatPair.
	 * 
	 * @param pair the FloatFloatPair to initialize from
	 */
	public FloatFloatPair(FloatFloatPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final FloatFloatPair other = (FloatFloatPair) obj;
