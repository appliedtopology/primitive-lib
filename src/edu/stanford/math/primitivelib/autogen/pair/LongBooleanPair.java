...
public class LongBooleanPair {
	...
	/**
	 * Constructor which initializes from another LongBooleanPair.
	 * 
	 * @param pair the LongBooleanPair to initialize from
	 */
	public LongBooleanPair(LongBooleanPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LongBooleanPair other = (LongBooleanPair) obj;
