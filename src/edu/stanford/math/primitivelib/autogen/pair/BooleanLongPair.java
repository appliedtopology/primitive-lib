...
public class BooleanLongPair {
	...
	/**
	 * Constructor which initializes from another BooleanLongPair.
	 * 
	 * @param pair the BooleanLongPair to initialize from
	 */
	public BooleanLongPair(BooleanLongPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final BooleanLongPair other = (BooleanLongPair) obj;
