...
/**
 * This class implements a pair (a, b), where a is a double and b 
...
public class DoubleFloatPair {
	...
	/**
	 * Constructor which initializes from another DoubleFloatPair.
	 * 
	 * @param pair the DoubleFloatPair to initialize from
	 */
	public DoubleFloatPair(DoubleFloatPair pair) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final DoubleFloatPair other = (DoubleFloatPair) obj;
